...
class TestAsciicast(unittest.TestCase):
    ...
    cast_v2_lines = [
        ...
        # Float idle time limit (https://github.com/khulnasoft-lab/svgterm/issues/97)
    ...
    color_theme_8 = AsciiCastV2Theme(
        fg="#000000",
        bg="#AAAAAA",
    ...
    cast_v2_events = [
        ...
        AsciiCastV2Event(
            0.010303, "o", "\u001b[1;31mnico \u001b[0;34m~\u001b[0m", None
        ),
    ...
    def test_from_json(self):
        ...
        failure_test_cases = [
            ...
            (
                "header v2: invalid height",
                '{"version": 2, "width": "212", "height": null}',
            ),
    ...
    def test__read_v1_records(self):
            ...
            with self.subTest(case="record #{}".format(index)):
                if isinstance(event, AsciiCastV2Header):
                    ...
                    self.assertAlmostEqual(
                        event.time, expected_event.time, delta=10e-10
                    )
        ...
        failure_test_cases = [
            (
                "invalid version",
                '{"version": null, "width": 212, "height": 53, "duration": 2, "stdout": []}',
            ),
            (
                "invalid width",
                '{"version": 1, "width": null, "height": 53, "duration": 2, "stdout": []}',
            ),
            (
                "invalid height",
                '{"version": 1, "width": 212, "height": "xx", "duration": 2, "stdout": []}',
            ),
            (
                "invalid stdout",
                '{"version": 1, "width": 212, "height": 53, "duration": 2, "stdout": 42}',
            ),
            (
                "missing version",
                '{"width": 212, "height": 53, "duration": 2, "stdout": []}',
            ),
            (
                "missing height",
                '{"version": 1, "width": 212, "duration": 2, "stdout": []}',
            ),
            (
                "invalid event",
                '{"version": 1, "width": 212, "height": 53, "duration": 2, "stdout": [[]]}',
            ),
            (
                "invalid event",
                '{"version": 1, "width": 212, "height": 53, "duration": 2, "stdout": [[0]]}',
            ),
            (
                "invalid event",
                '{"version": 1, "width": 212, "height": 53, "duration": 2, "stdout": [[0, "a", 2]]}',
            ),
            (
                "invalid event duration",
                '{"version": 1, "width": 212, "height": 53, "duration": 2, "stdout": [["aaa", "a"]]}',
            ),
            ("invalid JSON (header)", "#####"),
            (
                "invalid JSON (event)",
